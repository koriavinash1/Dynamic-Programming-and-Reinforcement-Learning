...
python3 ValueIterationBucketing.py --num_episodes 150 --num_bins 9 --verbose 0
...
python3 PolicyIterationBucketing.py --policy_iteration_type 'Inverse' --num_episodes 150 --num_bins 9 --verbose 0
...
python3 PolicyIterationBucketing.py --num_episodes 150 --num_bins 9 --verbose 0
...
python3 ValueIterationBucketing.py --num_episodes 150 --num_bins 9 --verbose 0 --reward_type 'irl_maxentropy' --irl_reward_path '../logs/ValueIteration_No_Bins_9/CartPole-v0/RESULTS/IRL/Max_entropy'
